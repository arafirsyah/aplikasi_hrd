					...
					<table border="1" width="1100">
						...
						<tr>
							<td>
								<?php 
									include "koneksi.php";
									$q = mysql_query("SELECT * FROM calonanggota WHERE nik='$_GET[nik]'"); //menampilkan data dimana nilai id = id yang ada di url 
									$r = mysql_fetch_array($q); // Cocokan data dengan data di database
									$q2 = mysql_query("SELECT * FROM detail_canggota WHERE nik='$_GET[nik]'"); //menampilkan data dimana nilai id = id yang ada di url 
									$r2 = mysql_fetch_array($q2); // Cocokan data dengan data di database
								?>
								<!--Buat Aksinya ke update.php-->
								<form name="formsimpan" method="POST" action="update1.php">
								...
								<table>
									<tbody>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" name="no_anggota" value="<?php echo $r2['no_anggota'];?>" /><font color="red" size="2">*) Jangan Dikosongkan</font>
											</td>
										</tr>
										<tr>
											<td>Copy KTP</td>
											<td>:</td>
											<td>
												<input type="text" name="copy_ktp" value="<?php echo $r2['copy_ktp'];?>" /><font color="red" size="2">*) Jangan Dikosongkan</font>
											</td>
										</tr>
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" name="jml_setoran" value="<?php echo $r2['jml_setoran'];?>" /><font color="red" size="2">*) Jangan Dikosongkan</font>
											</td>
										</tr>
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" name="tgl_setoran" value="<?php echo $r2['tgl_setoran'];?>" /><font color="red" size="2">*) - Format yyyy-mm-dd; - Jangan Dikosongkan</font>
											</td>
										</tr>
										<tr>
